...
| Для ***filter_peaks*** hg19 | 115115 | 112077 | ... | ... |
##### ***Количнство пиков при пересечении со всторичной структурой***
|| А549 |  H9 |
|----------------|:---------:|:---------:|
| Пересечение с **DeepZ** | 13121 | ...  |
| Пересещение **набора участников** | 14212 | пересечений |
